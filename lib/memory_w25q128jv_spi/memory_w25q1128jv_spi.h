...
class MemoryW25q1128jvSpi {
  public:
     ...
     * @retval Operation Failure, -1 for wrong device
     * @retval Operation Failure, -2 for full memory
     */
    int Init();
     ...
     * @retval Operation Sucess,   0 current read address value for success
     * @retval Operation Failure, -1 for SPI protocol failure
     * @retval Operation Failure, -2 for max memory read
     */
